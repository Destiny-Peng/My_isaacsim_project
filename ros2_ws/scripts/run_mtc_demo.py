#!/usr/bin/env python3
"""Run moveit_mtc_pick_place_demo/mtc_pick_place_demo.launch.py with YAML defaults."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Launch MTC demo from YAML profile")
